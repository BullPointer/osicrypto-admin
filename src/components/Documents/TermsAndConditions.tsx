...
import { editOrCreate, getAll } from "../../api/DocumentApis/TermAndCondition";
    ...
    if (result.status === 200) {
      try {
        if (result.data.data.length < 1) {
          ...
          setMessage("Term and Condition published sucessfully!");
          setTimeout(() => {
            setMessage(null);
          ...
          setMessage("Term and Condition edited sucessfully!");
          setTimeout(() => {
            setMessage(null);
            navigate("/admin/documents");
          }, 3000);
